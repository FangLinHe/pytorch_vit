...
class PatchEmbedder(nn.Module):
    def __init__(
        ...
        nn.init.uniform_(self.position_embeddings, a=-1.0, b=1.0)
    ...
    def forward(self, patches: torch.Tensor) -> torch.Tensor:
        ...
        patch_embeddings: torch.Tensor = torch.cat((repeated_class_token, projected_embeddings), dim=1)

        return patch_embeddings + self.position_embeddings
